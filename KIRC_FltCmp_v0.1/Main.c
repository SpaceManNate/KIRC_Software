...
volatile int input[4] = {533,533,533,533};
float total;
int total2;
...
Void ControlFxn(UArg arg0, UArg arg1) {
	//init vars
	float Kp=3.0,Ki=0.0,Kd=0.2;
	float Kpy=2.0,Kiy=0,Kdy=0;
	uint32_t output[4];
	float error[3];
	...
	while (1) {
		...
		yaw_input = (float) 5.0*(input[2] - 537)/430.0 - 2.5;
		...
		output[0] = input[0]+Compensation[0]-Compensation[1] + Compensation[2];
		output[1] = input[0]-Compensation[0]-Compensation[1] + Compensation[2];
		output[2] = input[0]+Compensation[0]+Compensation[1] - Compensation[2];
		output[3] = input[0]-Compensation[0]+Compensation[1] - Compensation[2];
