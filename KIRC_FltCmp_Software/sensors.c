...
void Filter_GyroData(void) {
	...
	Gyro_Memory[0] = (IMUdata.gyr[0] + Gyro_Memory[1] + Gyro_Memory[2]
			+ Gyro_Memory[3] + Gyro_Memory[4]) / 5;
	Gyro_Memory[5] = (IMUdata.gyr[1] + Gyro_Memory[6] + Gyro_Memory[7]
			+ Gyro_Memory[8] + Gyro_Memory[9]) / 5;
	Gyro_Memory[10] = (IMUdata.gyr[2] + Gyro_Memory[11] + Gyro_Memory[12]
			+ Gyro_Memory[13] + Gyro_Memory[14]) / 5;
...
//*************************************************************************
void I2C0_TxData(unsigned char Slave_Addr, unsigned char Reg_Addr,
		unsigned char Data) {
	// Set I2C port to write mode
	I2CMasterSlaveAddrSet(I2C0_BASE, Slave_Addr, false);
